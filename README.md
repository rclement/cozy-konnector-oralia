[Cozy][cozy] Oralia Cozy Connector
=======================================
...
This konnector retrieves your documents from Oralia.
...
cozy-konnector-oralia is developed by Romain Clement and distributed under the [AGPL v3 license][agpl-3.0].
